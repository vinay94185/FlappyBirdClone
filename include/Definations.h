#ifndef DEFINATIONS_H_INCLUDED
#define DEFINATIONS_H_INCLUDED
...
#define MIN_ROTATION -25.0f

#define FONT_SCORE_SIZE 128
#define GAME_OVER_FONT_SCORE_SIZE 56
